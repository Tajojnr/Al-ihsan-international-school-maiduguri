...
import { Settings, Save, Phone, Mail, MapPin, MessageCircle, Facebook, Instagram, Twitter, Youtube } from "lucide-react";
  ...
  return (
    <div>
      ...
      >
        ...
        <div className="glass-panel p-6 space-y-5">
          <h2 className="font-heading text-base font-semibold text-white border-b border-white/10 pb-3 flex items-center gap-2">
            <MessageCircle className="h-4 w-4 text-gold" /> Social Media Links
          </h2>
          <p className="text-[10px] text-slate-400">
            Paste the full URL to your school&apos;s social media profiles. Leave blank to hide an icon.
          </p>
          ...
          <div>
            <label className="block text-xs font-semibold uppercase tracking-wider text-pink-400 mb-1 flex items-center gap-1.5">
          ...
          <div>
            <label className="block text-xs font-semibold uppercase tracking-wider text-sky-400 mb-1 flex items-center gap-1.5">
          ...
          <div>
            <label className="block text-xs font-semibold uppercase tracking-wider text-red-400 mb-1 flex items-center gap-1.5">
